...
+ [IFKZ19], Sho Inaba (University of Massachusetts Boston);Carl Fakhry (University of Massachusetts Boston);Rahul Kulkarni (University of Massachusetts Boston);Kourosh Zarringhalam (University of Massachusetts Boston);, A free energy based approach for distance metric learning, 2019
+ [MZXZX19], Qingxin Meng (Rutgers- the State University of New Jersey);Hengshu Zhu (Baidu);Keli Xiao (Stony Brook University);Le Zhang (School of Computer Science, University of Science and Technology of China);Hui Xiong (Rutgers- the State University of New Jersey);, A Hierarchical Career-Path-Aware Neural Network for Job Mobility Prediction, 2019
+ [WQZWZGC19], Pinghui Wang (Xi'an Jiaotong University);Yiyan Qi (Xi'an Jiaotong University);Yuanming Zhang (Xi'an Jiaotong University);Chenxu Wang (Xi'an Jiaotong University);Qiaozhu Zhai (Xi'an Jiaotong University);Xiaohong Guan (Xi'an Jiaotong University);John C.S. Lui ( Tsinghua University);, A Memory-Efficient Sketch Method for Estimating High Similarities in Streaming Sets, 2019
+ [WQWLGZHZCZ19], Bo Wang (alibaba);Minghui Qiu (Alibaba);Xisen Wang (USTC);Yaliang Li (Alibaba);Yu Gong (Alibaba);Xiaoyi Zeng (Alibaba);Jun Huang (alibaba);Bo Zheng (Alibaba);Deng Cai (Zhejiang University);Jingren Zhou (Alibaba);, A Minimax Game for Instance based Selective Transfer Learning, 2019
+ [19], Yuchao Liu (Microsoft);Ery Arias-Castro (University of California San Diego);, A Multiscale Scan Statistic for Adaptive Submatrix Localization, 2019
+ [NPPTBMO19], Elias Chaibub Neto (Sage Bionetworks);Abhishek Pratap (Sage Bionetworks);Thanneer Perumal (Sage Bionetworks);Meghasyam Tummalacherla (Sage Bionetworks);Brian Bot (Sage Bionetworks);Lara Mangravite (Sage Bionetworks);Larsson Omberg (Sage Bionetworks);, A permutation approach to assess confounding in machine learning applications for digital health, 2019
+ [19], Yifan Hou (The Chinese University of Hong Kong);Hongzhi Chen (The Chinese University of Hong Kong);Changji Li (The Chinese University of Hong Kong);James Cheng (The Chinese University of Hong Kong);Ming-Chang Yang (The Chinese University of Hong Kong);, A Representation Learning Framework for Property Graphs, 2019
+ [19], Yang Yang (NanJing university);Da-Wei Zhou (Nanjing University);De-Chuan Zhan (Nanjing University);Hui Xiong (Rutgers University);Yuan Jiang (Nanjing University);, Adaptive Deep Models for Incremental Learning: Considering Capacity Scalability and Sustainability, 2019
+ [19], Dengbao Wang (Southwest University);Li Li (Southwest University);Min-Ling Zhang (Southeast University);, Adaptive Graph Guided Disambiguation for Partial Label Learning, 2019
+ [19], Jundong Li (Arizona State University);Ruocheng Guo (Arizona State University);Chenghao Liu (Singapore Management University);Huan Liu (Arizona State University);, Adaptive Unsupervised Feature Selection on Attributed Networks, 2019
+ [19], Thomas Hartvigsen (Worcester Polytechnic Institute);Cansu Sen (Worcester Polytechnic Institute);Xiangnan Kong (Worcester Polytechnic Institute);Elke Rundensteiner (Worcester Polytechnic Institute);, Adaptive-Halting Policy Network for Early Classification, 2019
+ [19], Junxiang Wang (George Mason University);Fuxun Yu (George Mason University);Xiang Chen (George Mason University);Liang Zhao (George Mason University);, ADMM for Efficient Deep Learning with Global Convergence, 2019
+ [19], Binbin Hu (Beijing University of Posts and Telecommunications && AI Department, Ant Financial Services Group);Yuan Fang (Singapore Management University);Chuan Shi (Beijing University of Posts and Telecommunications);, Adversarial Learning on Heterogeneous Information Networks, 2019
+ [19], Pengyang Wang (Missouri University of Science and Technology);Yanjie Fu (Missouri University of Science and Technology);Xiaolin Li (Nanjing University);Hui Xiong (Rutgers University);, Adversarial Substructured Representation Learning for Mobile User Profiling, 2019
+ [19], Xiang Zhang (The University of New South Wales);Lina Yao (The University of New South Wales);Feng Yuan (The University of New South Wales);, Adversarial Variational Embedding for Robust Semi-supervised Learning, 2019
+ [19], Dmitrii Avdiukhin (Indiana University Bloomington);Slobodan Mitrovic (MIT);Grigory Yaroslavtsev (Indiana University Bloomington);Samson Zhou (Indiana University Bloomington);, Adversarially Robust Submodular Maximization under Knapsack Constraints, 2019
+ [19], Tong Yu (Samsung Electronics);Yilin Shen (Samsung Electronics);Hongxia Jin (Samsung Electronics);, An Visual Dialog Augmented Interactive Recommender System, 2019
+ [19], Vinay Rao (Google);Ben Goodrich (Google);Peter Liu (Google);Mohammad Saleh (Google);, Assessing The Factual Accuracy of Generated Text, 2019
+ [19], Cong Fu (Zhejiang University);Yonghui Zhang (Zhejiang University);Deng Cai (Zhejiang University);Xiang Ren (University of Southern California);, AtSNE: Efficient and Robust Visualization on GPU through Hierarchical Optimization, 2019
+ [19], Hanchao Ma (Washington State University);Sheng Guan (Washington State University);Yinghui Wu (Washington State University);, Attribute-Driven Backbone Discovery, 2019
+ [19], Congzheng Song (Cornell University);Vitaly Shmatikov (Cornell University);, Auditing Data Provenance in Text-Generation Models, 2019
+ [19], Kunpeng Liu (Missouri University of Science and Technology);Yanjie Fu (Missouri University of Science and Technology);Pengfei Wang (CNIC, Chinese Academy of Sciences);Le Wu (Hefei University of Technology);Rui Bo (Missouri University of Science and Technology);Xiaolin Li (Nanjing University);, Automating Feature Subspace Exploration via Multi-Agent Reinforcement Learning, 2019
+ [19], Ke Tu (Tsinghua University);Jianxin Ma (Tsinghua University);Peng Cui (Tsinghua University);Jian Pei (JD.com);Wenwu Zhu (Tsinghua University);, AutoNRL: Hyperparameter Optimization for Massive Network Representation Learning, 2019
+ [19], Xuezhou Zhang (University of Wisconsin-Madison);Sarah Tan (Cornell University);Paul Koch (Microsoft);Yin Lou (Ant Financial);Urszula Chajewska (Microsoft);Rich Caruana (Microsoft);, Axiomatic Interpretability for Multiclass Additive Models, 2019
+ [19], Wenyi Xiao (The Hong Kong University of Science and Technology);Huan Zhao (The Hong Kong University of Science and Technology);Haojie Pan (The Hong Kong University of Science and Technology);Yangqiu Song (The Hong Kong University of Science and Technology);Vincent W. Zheng (WeBank, China);Qiang Yang (The Hong Kong University of Science and Technology);, Beyond Personalization: Social Content Recommendation for Creator Equality and Consumer Satisfaction, 2019
+ [19], Daniel Zügner (Technical University of Munich);Stephan Günnemann (Technical University of Munich);, Certifiable Robustness and Robust Training for Graph Convolutional Networks, 2019
+ [19], Wei-Lin Chiang (National Taiwan University);Xuanqing Liu (University of California, Los Angeles);Si Si (Google);Yang Li (Google);Samy Bengio (Google);Cho-Jui Hsieh (University of California, Los Angeles);, Cluster-GCN: An Efficient Algorithm for Training Deep and Large Graph Convolutional Networks, 2019
+ [19], Sara Ahmadian (Google);Alessandro Epasto (Google);Ravi Kumar (Google);Mohammad Mahdian (Google);, Clustering without Over-Representation, 2019
+ [19], Junchen Ye (SKLSDE Lab and BDBC Beihang University);Leilei Sun (SKLSDE Lab and BDBC Beihang University);Bowen Du (SKLSDE Lab and BDBC Beihang University);Yanjie Fu (Missouri University of Science and Technology);Xinran Tong (SKLSDE Lab and BDBC Beihang University);Hui Xiong (Rutgers Business School Rutgers University);, Co-Prediction of Multiple Transportation Demands Based on Deep Spatio-Temporal Neural Network, 2019
+ [19], Hongchang Gao (University of Pittsburgh);Jian Pei (Simon Fraser University);Heng Huang (University of Pittsburgh);, Conditional Random Field Enhanced Graph Convolutional Neural Networks, 2019
+ [19], Silu Huang (University of Illinois Urbana-Champaign);Jialu Liu (Google);Flip Korn (Google);Xuezhi Wang (Google);You Wu (Google);Dale Markowitz (Google);Cong Yu (Google);, Contextual Fact Ranking and Its Applications in Table Synthesis and Compression, 2019
+ [19], Anes Bendimerad (LIRIS);Jefrey Lijffijt (Dept. of Electronics and Information Systems, IDLab, Ghent University);Marc Plantevit (LIRIS);Celine Robardet (INSA Lyon);Tijl De Bie (Dept. of Electronics and Information Systems, IDLab, Ghent University);, Contrastive antichains in hierarchies, 2019
+ [19], Yanhao Wang (National University of Singapore);Yuchen Li (Singapore Management University);Kian-Lee Tan (National University of Singapore);, Coresets for Minimum Enclosing Balls over Sliding Windows, 2019
+ [19], Hanpeng Liu (Univeristy of Southern California);Yaguang Li (Univeristy of Southern California);Michael Tsang (University of Southern California);Yan Liu (University of Southern California);, CoSTCo: A Nonlinear Sparse Tensor Completion Model, 2019
+ [19], Qingquan Song (Texas A&M University);Shiyu Chang (IBM);Xia Hu (Texas A&M University);, Coupled Variational Recurrent Collaborative Filtering, 2019
+ [19], Donghua Liu (School of Computer Science Wuhan University);Jing Li (School of Computer Science Wuhan University);Bo Du (School of Computer Science Wuhan University);Jun Chang (School of Computer Science Wuhan University);Rong Gao (School of Computer Science Hubei University of Technology);, DAML: Dual Attention Mutual Learning between Ratings and Reviews for Item Recommendation, 2019
+ [19], Guansong Pang (The University of Adelaide);Chunhua Shen (The University of Adelaide);Anton van den Hengel (The University of Adelaide);, Deep Anomaly Detection with Deviation Networks, 2019
+ [19], Kan Ren (Shanghai Jiao Tong University);Jiarui Qin (Shanghai Jiao Tong University);Lei Zheng (Shanghai Jiao Tong University);Zhengyu Yang (Shanghai Jiao Tong University);Weinan Zhang (Shanghai Jiao Tong University);Yong Yu (Shanghai Jiao Tong University);, Deep Landscape Forecasting for Real-time Bidding Advertising, 2019
+ [19], Maya Okawa (NTT);Tomoharu Iwata (NTT);Takeshi Kurashima (NTT);Yusuke Tanaka (NTT);Hiroyuki Toda (NTT);Naonori Ueda (NTT);, Deep Mixture Point Processes: Spatio-temporal Event Prediction with Rich Contextual Information, 2019
+ [19], Guolin Ke (Microsoft);Zhenhui Xu (Peking University);Jia Zhang (Microsoft);Jiang Bian (Microsoft);Tie-Yan Liu (Microsoft);, DeepGBM: A Deep Learning Framework Distilled by GBDT for Online Prediction Tasks, 2019
+ [19], Kai Shu (Arizona State University);Limeng Cui (The Pennsylvania State University);Suhang Wang (The Pennsylvania State University);Dongwon Lee (Penn State Univeristy);Huan Liu (Arizona State University);, dEFEND: Explainable Fake News Detection, 2019
+ [19], Jun Wu (Arizona State University);Jingrui He (Arizona State University);Jiejun Xu (HRL Laboratories, LLC);, DEMO-Net: Degree-specific Graph Neural Networks for Node and Graph Classification, 2019
+ [19], Jing-Han Wu (Southeast University);Min-Ling Zhang (Southeast University);, Disambiguation Enabled Linear Discriminant Analysis for Partial Label Dimensionality Reduction, 2019
+ [19], Michael Doron (Hebrew University of Jerusalem);Idan Segev (Hebrew University of Jerusalem);Dafna Shahaf (Hebrew University of Jerusalem);, Discovering Unexpected Local Nonlinear Interactions in Scientific Black-box Models, 2019
+ [19], Baojian Zhou (University at Albany, SUNY);Feng Chen (University at Albany, SUNY);Yiming Ying (University at Albany, SUNY);, Dual Averaging Method for Online Graph-structured Sparsity, 2019
+ [19], Qitian Wu (Shanghai Jiao Tong University);Yirui Gao (Shanghai Jiao Tong University);Xiaofeng Gao (Shanghai Jiao Tong University);Paul Weng (Shanghai Jiao Tong University);Guihai Chen (Shanghai Jiao Tong University);, Dual Sequential Prediction Models Linking Sequential Recommendation and Information Dissemination, 2019
+ [19], Yasuko Matsubara (Kumamoto University);Yasushi Sakurai (Kumamoto University);, Dynamic Modeling and Forecasting of Time-evolving Data Streams, 2019
+ [19], Chengxi Zang (Tsinghua University);Peng Cui (Tsinghua University);Wenwu Zhu (Tsinghua University);Fei Wang (Cornell University);, Dynamical Origins of Distribution Functions, 2019
+ [19], Peizhen Li (School of Data and Computer Science,Sun Yat-sen University,Guangzhou, P. R. China);Ling Huang (Sun Yat-sen University);Chang-Dong Wang (Sun Yat-sen University);Jianhuang Lai (Sun Yat-sen University);, EdMot: An Edge Enhancement Approach for Motif-aware Community Detection, 2019
...
+ [19], Zheng Wang (Nanyang Technological University);Cheng Long (Nanyang Technological University);Gao Cong (Nanyang Technological University);Ce Ju (IDG Baidu Inc.);, Effective and Efficient Sports Play Retrieval with Deep Representation Learning, 2019
+ [19], Yexin Li (The Hong Kong University of Science and Technology);Yu Zheng (Urban Computing Business Unit, JD Finance);Qiang Yang (The Hong Kong University of Science and Technology);, Efficient and Effective Express via Contextual Cooperative Reinforcement Learning, 2019
+ [19], Lingfei Wu (IBM);Ian En-Hsu Yen (Carnegie Mellon University);Siyu Huo (IBM);Liang Zhao (George Mason University);Kun Xu (Peking University);Liang Ma (IBM);Shouling Ji (Zhejiang University);Charu Aggarwal (IBM);, Efficient Global String Kernel with Random Features: Beyond Counting Substructures, 2019
+ [19], Lijun Chang (The University of Sydney), Efficient Maximum Clique Computation over Large Sparse Graphs, 2019
+ [19], Chi Wang (Microsoft);Bailu Ding (Microsoft);, Empirical Entropy Approximation via Subsampling: Theory and Application, 2019
+ [19], Jingyuan Wang (Beihang University);Ning Wu (Beihang University);Xin Zhao (Renmin University of China);Fanzhang Peng (Beihang University);Xin Lin (Beihang University);, Empowering A* Search Algorithms with Neural Networks for Personalized Route Recommendation, 2019
+ [19], Qinyong Wang (The University of Queensland);Hongzhi Yin (The University of Queensland);Hao Wang (The University of Tokyo);Quoc Viet Hung Nguyen (Griffith University);Zi Huang (The University of Queensland);Lizhen Cui (Shandong University);, Enhancing Collaborative Filtering with Generative Augmentation, 2019
+ [19], Shibo Yao (New Jersey Institute of Technology);Dantong Yu (New Jersey Institute of Technology);Keli Xiao (Stony Brook University);, Enhancing Domain Word Embedding via Latent Semantic Imputation, 2019
+ [19], Wenjie Shang (Nanjing University);Yang Yu (Nanjing University);Qingyang Li (AI Labs, Didi Chuxing);Zhiwei Qin (AI Labs, Didi Chuxing);Yiping Meng (AI Labs, Didi Chuxing);Jieping Ye (AI Labs, Didi Chuxing);, Environment Reconstruction with Hidden Confounders for Reinforcement Learning based Recommendation, 2019
+ [19], Bijaya Adhikari (Virginia Tech);Xinfeng Xu (Virginia Tech);Naren Ramakrishnan (Virginia Tech);B. Aditya Prakash (Virginia Tech);, EpiDeep: Exploiting Embeddings for Epidemic Forecasting, 2019
+ [19], Dmitry Shemetov (University of California, Davis);James Sharpnack (University of California, Davis);Kirill Paramonov (University of California, Davis);, Estimating Graphlet Statistics via Lifting, 2019
+ [19], Namyong Park (Carnegie Mellon University);Andrey Kan (Amazon);Xin Luna Dong (Amazon);Tong Zhao (Amazon);Christos Faloutsos (Carnegie Mellon University and Amazon);, Estimating Node Importance in Knowledge Graphs Using Graph Neural Networks, 2019
+ [19], Songshan Yang (The Pennsylvania State University);Jiawei Wen (The Pennsylvania State University);Xiang Zhan (The Pennsylvania State University);Daniel Kifer (The Pennsylvania State University);, ET-Lasso: A New Efficient Tuning of Lasso-type Regularization for High-Dimensional Data, 2019
+ [19], Yu Gong (Alibaba Group);Yu Zhu (Alibaba Group);Lu Duan (Zhejiang Cainiao Supply Chain Management Co., Ltd);Qingwen Liu (Alibaba Group);Ziyu Guan (Xidian University);Fei Sun (Alibaba);Wenwu Ou (Alibaba Group);Kenny Zhu (Shanghai Jiao Tong University);, Exact-K Recommendation via Maximal Clique Optimization, 2019
+ [19], Qi Liu (University of Science and Technology of China);Shiwei Tong (University of Science and Technology of China);Chuanren Liu (Drexel University);Hongke Zhao (The College of Management and Economics, Tianjin University);Enhong Chen (University of Science and Technology of China);Haiping Ma (IFLYTEK CO., LTD.);Shijin Wang (IFLYTEK CO., LTD.);, Exploiting Cognitive Structure for Adaptive Learning, 2019
+ [19], Qingyun Wu (University of Virginia);Zhige Li (Shanghai Jiao Tong University);Huazheng Wang (University of Virginia);Wei Chen (Microsoft);Hongning Wang (University of Virginia);, Factorization Bandits for Online Influence Maximization, 2019
+ [19], Minji Yoon (Carnegie Mellon University);Bryan Hooi (Carnegie Mellon University);Kijung Shin (Carnegie Mellon University);Christos Faloutsos (Carnegie Mellon University);, Fast and Accurate Anomaly Detection in Dynamic Graphs with a Two-Pronged Approach, 2019
+ [19], Haoyang Li (Tsinghua University);Peng Cui (Tsinghua University);Chengxi Zang (Tsinghua University);Tianyang Zhang (Tsinghua University);Wenwu Zhu (Tsinghua University);Yishi Lin (Tencent);, Fates of Microscopic Social Ecosystems: Keep Alive or Dead?, 2019
+ [19], Victor Amelkin (University of Pennsylvania);Ambuj Singh (University of California, Santa Barbara);, Fighting Opinion Control in Social Networks via Link Recommendation, 2019
+ [19], Nikita Klyuchnikov (Tsuru Robotics);Davide Mottin (Aarhus University);Georgia Koutrika (Athena Research Center);Emmanuel Müller (University of Bonn);Panagiotis Karras (Aarhus University);, Figuring out the User in a Few Steps: Bayesian Multifidelity Active Search with Cokriging, 2019
+ [19], Hao Zou (Tsinghua University);Kun Kuang (Tsinghua University);Boqi Chen (Boston University);Peng Cui (Tsinghua University);Peixuan Chen (Tencent);, Focused Context Balancing for Robust Offline Policy Evaluation, 2019
...
+ [19], Nicholas Monath (Google);Manzil Zaheer (Google);Daniel Silva (Google);Andrew McCallum (University of Massachusetts Amherst);Amr Amhed (Google);, Gradient-based Hierarchical Clustering using Continuous Representations of Trees in Hyperbolic Space, 2019
+ [19], Yao Ma (Michigan State University);Suhang Wang (The Pennsylvania State University);Charu Aggarwal (IBM);Jiliang Tang (Michigan State University);, Graph Convolutional Networks with EigenPooling, 2019
+ [19], Xiao Huang (Texas A&M University);Qingquan Song (Texas A&M University);Yuening Li (Texas A&M University);Xia Hu (Texas A&M University);, Graph Recurrent Networks with Attributed Random Walks, 2019
+ [19], Hongyang Gao (Texas A&M University);Shuiwang Ji (Texas A&M University);, Graph Representation Learning via Hard and Channel-Wise Attention Networks, 2019
+ [19], Kien Do (Deakin University);Truyen Tran (Deakin University);Svetha Venkatesh (Deakin University);, Graph Transformation Policy Network for Chemical Reaction Prediction, 2019
+ [19], Junteng Jia (Cornell University);Michael Schaub (Massachusetts Institute of Technology);Santiago Segarra (Rice University);Austin Benson (Cornell University);, Graph-based Semi-Supervised & Active Learning for Edge Flows, 2019
+ [19], Yujun Yan (University of Michigan);Jiong Zhu (University of Michigan);Marlena Duda (University of Michigan);Eric Solarz (University of Michigan);Chandra Sripada (University of Michigan);Danai Koutra (University of Michigan);, GroupINN: Grouping-based Interpretable Neural Network for Classification of Limited, Noisy Brain Data, 2019
+ [19], Changping Meng (Purdue University);Jiasen Yang (Purdue University);Bruno Ribeiro (Purdue University);Jennifer Neville (Purdue University);, HATS: A Hierarchical Sequence-Attention Framework for Inductive Set-of-Sets Embeddings, 2019
+ [19], Chuxu Zhang (University of Notre Dame);Dongjin Song (NEC Laboratories America);Chao Huang (University of Notre Dame);Ananthram Swami (US);Nitesh V. Chawla (University of Notre Dame);, HetGNN: Heterogeneous Graph Neural Network, 2019
+ [19], Zhe Jiang (The University of Alabama);Arpan Man Sainju (The University of Alabama);, Hidden Markov Contour Tree: A Spatial Structured Model for Hydrological Applications, 2019
+ [19], Yue Cui (“University of Electronic Science and Technology of China”);Liwei Deng (“University of Electronic Science and Technology of China”);Yan Zhao (School of Computer Science and Technology, Soochow University);Vicent Zheng (WeBank);Bin Yao (Shanghai Jiao Tong University);Kai Zheng (“University of Electronic Science and Technology of China”);, Hidden POI Ranking with Spatial Crowdsourcing, 2019
+ [19], Chen Ma (McGill University);Peng Kang (Northwestern University);Xue Liu (McGill University);, Hierarchical Gating Networks for Sequential Recommendation, 2019
+ [19], Hongliang Fei (Baidu);Shulong Tan (Baidu);Ping Li (Baidu);, Hierarchical Multi-Task Word Embedding Learning for Medical Synonym Prediction, 2019
+ [19], Kishlay Jha (University of Virginia);Guangxu Xun (University of Virginia);Yaqing Wang (University at Buffalo);Aidong Zhang (University of Virginia);, Hypothesis Generation From Text Based On Co-Evolution Of Biomedical Concepts, 2019
+ [19], Alexander Marx (Max Planck Institute for Informatics);Jilles Vreeken (CISPA);, Identifiability of Cause and Effect using Regularized Regression, 2019
+ [19], Yunzhe Jia (The University of Melbourne);James Bailey (The University of Melbourne);Kotagiri Ramamohanarao (The University of Melbourne);Christopher Leckie (The University of Melbourne);Michael E. Houle (National Institute of Informatics, Japan);, Improving the quality of explanations with local embedding perturbations, 2019
+ [19], Weiyu Cheng (Shanghai Jiao Tong University);Yanyan Shen (Shanghai Jiao Tong University);Linpeng Huang (Shanghai Jiao Tong University);Yanmin Zhu (Shanghai Jiao Tong University);, Incorporating Interpretability into Latent Factor Models via Fast Influence Analysis, 2019
+ [19], Zhige Li (Shanghai Jiao Tong University);Derek Yang (Tsinghua University);Li Zhao (Microsoft);Jiang Bian (Microsoft);Tao Qin (Microsoft);Tie-Yan Liu (Microsoft);, Individualized Indicator for All: Stock-wise Technical Indicator Optimization with Stock Embedding, 2019
+ [19], Yao Ming (The Hong Kong University of Science and Technology);Panpan Xu (Bosch Research North America);Huamin Qu (The Hong Kong University of Science and Technology);Liu Ren (Bosch Research North America);, Interpretable and Steerable Sequence Learning via Prototypes, 2019
+ [19], Rui Yan (Peking University);Ran Le (Peking University);Yang Song (Boss Zhipin NLP Center);Tao Zhang (Boss Zhipin NLP Center);Xiangliang Zhang (KAUST);Dongyan Zhao (Peking University);, Interview Choice Reveals Your Preference on the Market:To Improve Job-Resume Matching through Profiling Memories, 2019
+ [19], Mengyang Liu (Tsinghua University);Jiaxin Mao (Tsinghua University);Yiqun Liu (Tsinghua University);Min Zhang (Tsinghua University);Shaoping Ma (Tsinghua University);, Investigating Cognitive Effects in Session-level Search User Satisfaction, 2019
+ [19], Ninghao Liu (Texas A&M University);Qiaoyu Tan (Texas A&M University);Yuening Li (Texas A&M University);Hongxia Yang (Alibaba);Jingren Zhou (Alibaba);Xia Hu (Texas A&M University);, Is a Single Vector Enough? Exploring Node Polysemy for Network Embedding, 2019
+ [19], Bi-Cun Xu (Nanjing University);Kai Ming Ting (School of Engineering and Information Technology, Federation University);Zhi-Hua Zhou (Nanjing University);, Isolation Set-Kernel and Its Application to Multi-Instance Learning, 2019
+ [19], Feiping Nie (School of Computer Science and Center for OPTIMAL, Northwestern Polytechnical University, China.);Cheng-Long Wang (School of Computer Science and Center for OPTIMAL, Northwestern Polytechnical University, China.);Xuelong Li (School of Computer Science and Center for OPTIMAL, Northwestern Polytechnical University, China.);, K-Multiple-Means: A Multiple-Means Clustering Method with Specified K Clusters, 2019
+ [19], Xiang Wang (National University of Singapore);Xiangnan He (University of Science and Technology of China);Yixin Cao (National University of Singapore);Meng Liu (Shandong University);Tat-Seng Chua (National University of Singapore);, KGAT: Knowledge Graph Attention Network for Recommendation, 2019
+ [19], Hongwei Wang (Shanghai Jiao Tong University);Fuzheng Zhang (Meituan-Dianping Group);Mengdi Zhang (Meituan-Dianping Group);Jure Leskovec (Stanford University);Miao Zhao (The Hong Kong Polytechnic University);Wenjie Li (The Hong Kong Polytechnic University);Zhongyuan Wang (Meituan-Dianping Group);, Knowledge-aware Graph Neural Networks with Label Smoothness Regularization for Recommender Systems, 2019
+ [19], Di Jin (University of Michigan);Ryan Rossi (Adobe);Danai Koutra (University of Michigan);Eunyee Koh (Adobe);Sungchul Kim (Adobe);Anup Rao (Adobe);, Latent Network Summarization: Bridging Network Embedding and Summarization, 2019
+ [19], Ming-Kun Xie (Nanjing University of Aeronautics and Astronautics);Sheng-Jun Huang (Nanjing University of Aeronautics and Astronautics);, Learning Class-Conditional GANs with Active Sampling, 2019
+ [19], Songgaojun Deng (Stevens Institute of Technology);Huzefa Rangwala (George Mason University);Yue Ning (Stevens Institute of Technology);, Learning Dynamic Context Graphs for Predicting Social Events, 2019
+ [19], Zhen-Yu Zhang (Nanjing University);Peng Zhao (Nanjing University);Yuan Jiang (Nanjing University);Zhi-Hua Zhou (Nanjing University);, Learning from Incomplete and Inaccurate Supervision, 2019
+ [19], Tomoki Yoshida (Nagoya Institute of Technology);Ichiro Takeuchi (Nagoya Institute of Technology, National Institute for Material Science, RIKEN Center for Advanced Intelligence Project);Masayuki Karasuyama (Nagoya Institute of Technology, National Institute for Material Science, Japan Science and Technology Agency);, Learning Interpretable Metric between Graphs: Convex Formulation and Computation with Graph Mining, 2019
+ [19], Zhicheng He (Nankai University);Jie Liu (Nankai University);Na Li (Nankai University);Yalou Huang (Nankai University);, Learning Network-to-Network Model for Content-rich Network Embedding, 2019
+ [19], Pinghua Xu (Wuhan University);Wenbin Hu (Wuhan University);Jia Wu (Macquarie University);Bo Du (Wuhan University);, Link Prediction with Signed Latent Factors in Signed Social Networks, 2019
+ [19], Zhiqiang Tao (Northeastern University);Sheng Li (University of Georgia);Zhaowen Wang (Adobe);Chen Fang (Bytedance);Longqi Yang (Cornell University);Handong Zhao (Adobe);Yun Fu (Northeastern University);, Log2Intent: Towards Interpretable User Modeling via Recurrent Semantics Memory Unit, 2019
+ [19], Hao Wang (University of Science and Technology of China);Tong Xu (University of Science and Technology of China);Qi Liu (University of Science and Technology of China);Defu Lian (University of Science and Technology of China);Enhong Chen (University of Science and Technology of China);Dongfang Du (Tencent);Han Wu (University of Science and Technology of China);Wen Su (Tencent);, MCNE: An End-to-End Framework for Learning Multiple Conditional Network Representations of Social Network, 2019
+ [19], Hoyeop Lee (NCSOFT Co.);Jinbae Im (NCSOFT Co.);Seongwon Jang (NCSOFT Co.);Hyunsouk Cho (NCSOFT Co.);Sehee Chung (NCSOFT Co.);, MeLU: Meta-Learned User Preference Estimator for Cold-Start Recommendation, 2019
+ [19], Hanwen Zha (University of California, Santa Barbara);Wenhu Chen (University of California, Santa Barbara);Keqian Li (University of California, Santa Barbara);Xifeng Yan (University of California, Santa Barbara);, Mining Algorithm Roadmap in Scientific Publications, 2019
+ [19], Haoyu Zhang (Indiana University Bloomington);Qin Zhang (Indiana University Bloomington);, MinJoin: Efficient Edit Similarity Joins via Local Hash Minima, 2019
+ [19], Hemank Lamba (Carnegie Mellon University);Neil Shah (Snap Research);, Modeling Dwell Time Engagement on Visual Multimedia, 2019
+ [19], Daizong Ding (Fudan University);Mi Zhang (Fudan University);Xudong Pan (Fudan University);Min Yang (School of Computer Science, Fudan University);Xiangnan He (University of Science and Technology of China);, Modeling Extreme Events in Time Series Prediction, 2019
...
+ [19], Chang Li (School of Computer Science University of Sydney);Dongjin Song ( Capital Market CRC);Dacheng Tao (NEC);, Multi-task Recurrent Neural Network and Higher-order Markov Random Fields for Stock Price Prediction, 2019
+ [19], Jiejie Zhao (Beihang University);Bowen Du (Beihang University);Leilei Sun (Beihang University);Fuzhen Zhuang (Chinese Academy of Sciences);Weifeng Lv (Beihang University);Hui Xiong (Rutgers University);, Multiple Relational Attention Network for Multi-task Learning, 2019
+ [19], Kun Dong (Cornell University);Austin Benson (Cornell University);David Bindel (Cornell University);, Network Density of States, 2019
+ [19], Dingqi Yang (eXascale Infolab, University of Fribourg,);Paolo Rosso (University of Fribourg);Bin Li (Fudan University);Philippe Cudre-Mauroux (U. of Fribourg);, NodeSketch: Highly-Efficient Graph Embeddings via Recursive Sketching, 2019
+ [19], Chengrun Yang (Cornell University);Yuji Akimoto (Cornell University);Dae Won Kim (Cornell University);Madeleine Udell (Cornell University);, OBOE: Collaborative Filtering for AutoML Model Selection, 2019
+ [19], Li He (Data Science Lab, JD.com);Long Xia (Data Science Lab, JD.com);Wei Zeng (Institute of Computing Technology, Chinese Academy of Sciences);Zhi-Ming Ma (JD.com);Yihong Zhao (JD.com);Dawei Yin (JD.com);, Off-policy Learning for Multiple Loggers, 2019
+ [19], Yu-Chia Chen (University of Washington);Avleen S. Bijral (Microsoft);Juan Lavista Ferres (Microsoft);, On Dynamic Network Models and Application to Causal Impact, 2019
+ [19], Yipeng Zhang (RMIT University);Yuchen Li (Singapore Management University);Zhifeng Bao (RMIT University);Songsong Mo (Wuhan University);Ping Zhang (Huawei);, Optimizing Impression Counts for Outdoor Advertising, 2019
+ [19], Mohammadreza Esfandiari (NJIT);Dong Wei (NJIT);Sihem Amer-Yahia (CNRS);Senjuti Basu Roy (New Jersey Institute Of Technology);, Optimizing Peer Learning in Online Groups with Affinities, 2019
+ [19], Yuandong Wang (Beihang University);Hongzhi Yin (The University of Queensland);Hongxu Chen (The University of Queensland);Tianyu Wo (Beihang University);Jie Xu (University of Leeds);Kai Zheng (University of Electronic Science and Technology);, Origin-Destination Matrix Prediction via Graph Convolution: A New Perspective of Passenger Demand Modeling, 2019
+ [19], Lucas Maystre (Ecole Polytechnique Fédérale de Lausanne);Victor Kristof (Ecole Polytechnique Fédérale de Lausanne);Matthias Grossglauser (Ecole Polytechnique Fédérale de Lausanne);, Pairwise Comparisons with Flexible Time-Dynamics, 2019
+ [19], Ari Kobren (University of Massachusetts Amherst);Barna Saha (University of Massachusetts Amherst);Andrew McCallum (University of Massachusetts Amherst);, Paper Matching with Local Fairness Constraints, 2019
+ [19], Sanjoy Dey (IBM);Ping Zhang (The Ohio State University);Daby Sow (IBM);Kenney Ng (IBM);, PerDREP: Personalized Drug Eﬀectiveness Prediction from Longitudinal Observational Data, 2019
+ [19], Srijan Kumar (Stanford University);Xikun Zhang (University of Illinois at Urbana-Champaign);Jure Leskovec (Stanford University);, Predicting Dynamic Embedding Trajectory in Temporal Interaction Networks, 2019
+ [19], Jia Li (The Chinese University of Hong Kong);Zhichao Han (The Chinese University of Hong Kong);Hong Cheng (The Chinese University of Hong Kong);Jiao Su (The Chinese University of Hong Kong);Pengyun Wang (Noah Ark's Lab, Huawei Technologies);Jianfeng Zhang (Noah Ark's Lab, Huawei Technologies);Lujia Pan (Noah Ark's Lab, Huawei Technologies);, Predicting Path Failure In Time-Evolving Graphs, 2019
+ [19], Hua Wei (The Pennsylvania State University);Chacha Chen (Shanghai Jiao Tong University);Guanjie Zheng (The Pennsylvania State University);Kan Wu (The Pennsylvania State University);Vikash Gayah (The Pennsylvania State University);Kai Xu (Tianrang Inc.);Zhenhui Jessie Li (The Pennsylvania State University);, PressLight: Learning Max Pressure Control for Signalized Intersections in Arterial Network, 2019
+ [19], Yi Li (Tsinghua University);Wei Xu (Tsinghua University);, PrivPy: General and Scalable Privacy-Preserving Data Mining, 2019
+ [19], Hongchang Gao (University of Pittsburgh);Jian Pei (Simon Fraser University);Heng Huang (University of Pittsburgh);, ProGAN: Network Embedding via Proximity Generative Adversarial Network, 2019
+ [19], Francois Belletti (Google);Minmin Chen (Google);Ed Chi (Google);, Quantifying Long Range Dependence in Language and User Behavior to improve RNNs, 2019
+ [19], Yu Yin (University of Science and Technology of China);Qi Liu (University of Science and Technology of China);Zhenya Huang (University of Science and Technology of China);Enhong Chen (University of Science and Technology of China);Wei Tong (University of Science and Technology of China);Shijin Wang (iFLYTEK Research);Yu Su (iFLYTEK Research);, QuesNet: A Unified Representation for Heterogeneous Test Questions, 2019
+ [19], Souhaib Ben Taieb (University of Mons);Bonsoo Koo (Monash University);, Regularized regression for hierarchical forecasting without unbiasdness conditions, 2019
+ [19], Shimin Di (The Hong Kong University of Secience and Technology);Yanyan Shen (Shanghai Jiao Tong University);Lei Chen (The Hong Kong University of Science and Technology);, Relation Extraction via Domain-aware Transfer Learning, 2019
+ [19], Yukuo Cen (Tsinghua University);Xu Zou (Tsinghua University);Jianwei Zhang (Alibaba);Hongxia Yang (Alibaba);Jingren Zhou (Alibaba);Jie Tang (Tsinghua University);, Representation Learning for Attributed Multiplex Heterogeneous Network, 2019
+ [19], Fengyi Tang (Michigan State University);Cao Xiao (IQVIA);Fei Wang (Cornell University);Jiayu Zhou (Michigan State University);Li-Wei Lehman (Massachusetts Institute of Technology);, Retaining Privileged Information for Multi-Task Learning, 2019
+ [19], Parikshit Ram (IBM);Kaushik Sinha (Wichita State University);, Revisiting kd-tree for Nearest Neighbor Search, 2019
+ [19], Jie Zhao (The Ohio State University);Ziyu Guan (Xidian University);Huan Sun (The Ohio State University);, Riker: Mining Rich Keyword Representations for Interpretable Product Question Answering, 2019
+ [19], Dingyuan Zhu (Tsinghua University);Ziwei Zhang (Tsinghua University);Peng Cui (Tsinghua University);Wenwu Zhu (Tsinghua University);, Robust Graph Convolutional Networks Against Adversarial Attacks, 2019
+ [19], Yaqiang Yao (University of Science and Technology of China);Jie Cao (Jiangsu Provincial Key Laboratory of E-Business, Nanjing University of Finance and Economics);Huanhuan Chen (University of Science and Technology of China);, Robust Task Grouping with Representative Tasks for Clustered Multi-Task Learning, 2019
+ [19], Lingfei Wu (IBM);Ian En-Hsu Yen (Carnegie Mellon University);Zhen Zhang (Washington University in St. Louis);Kun Xu (Peking University);Liang Zhao (George Mason University);Xi Peng (Binghamton University);Yinglong Xia (Huawei);Charu Aggarwal (IBM);, Scalable Global Alignment Graph Kernel Using Random Features: From Node Embedding to Graph Embedding, 2019
+ [19], Yuan Yin (School of Information, Renming University);Zhewei Wei (School of Information, Renming University);, Scalable Graph Embeddings via Sparse Transpose Proximities, 2019
+ [19], Nicholas Monath (University of Massachusetts Amherst);Ari Kobren (UMass Amherst);Akshay Krishnamurthy (University of Massachusetts, Amherst);Michael Glass (IBM);Andrew Mccallum (University of Massachusetts);, Scalable Hierarchical Clustering via Tree Grafting, 2019
+ [19], Edouard Fouché (Karlsruhe Institute of Technology);Junpei Komiyama (The University of Tokyo);Klemens Böhm (Karlsruhe Institute of Technology);, Scaling Multi-Armed Bandit Algorithms, 2019
+ [19], Parameswaran Raman (University of California, Santa Cruz);Sriram Srinivasan (University of California, Santa Cruz);Shin Matsushima (The University of Tokyo);Xinhua Zhang (University of Illinios, Chicago);Hyokun Yun (Amazon);Vishwanathan S.V.N. (Amazon);, Scaling Multinomial Logistic Regression via Hybrid Parallelism, 2019
+ [19], Luobao Zou (Shanghai Jiao Tong University);Zhiwei Zhuang (Shanghai Jiao Tong University);Yin Cheng (Shanghai Jiao Tong University);Xuechun Wang (Shanghai Jiao Tong University);Weidong Zhang (Shanghai Jiao Tong University);, Separated Trust Regions Policy Optimization Method, 2019
+ [19], Min-Hwan Oh (Columbia University);Garud Iyengar (Columbia University);, Sequential Anomaly Detection using Inverse Reinforcement Learning, 2019
+ [19], Haoji Hu (University of Minnesota);Xiangnan He (University of Science and Technology of China);, Sets2Sets: Learning from Sequential Sets with Neural Networks, 2019
+ [19], Madelon Hulsebos (Massachusetts Institute of Technology);Kevin Hu (Massachusetts Institute of Technology);Michiel Bakker (Massachusetts Institute of Technology);Emanuel Zgraggen (Massachusetts Institute of Technology);Arvind Satyanarayan (Massachusetts Institute of Technology);Tim Kraska (Massachusetts Institute of Technology);Çağatay Demiralp (Massachusetts Institute of Technology);César Hidalgo (Massachusetts Institute of Technology);, Sherlock: A Deep Learning Approach to Semantic Data Type Detection, 2019
+ [19], Rafael Savvides (University of Helsinki);Andreas Henelius (University of Helsinki);Emilia Oikarinen (University of Helsinki);Kai Puolamäki (University of Helsinki);, Significance of Patterns in Data Visualisations, 2019
+ [19], Xin Wang (Tsinghua University);Wenwu Zhu (Tsinghua University);Chenghao Liu (Singapore Management University);, Social Recommendation with Optimal Limited Attention, 2019
+ [19], Leonardo Pellegrina (University of Padova);Matteo Riondato (Amherst College);Fabio Vandin (University of Padova);, SPuManTE: Significant Pattern Mining with Unconditional Testing, 2019
+ [19], Saurabh Verma (University of Minnesota);Zhi-Li Zhang (University of Minnesota);, Stability and Generalization of Graph Convolutional Neural Networks, 2019
+ [19], Hongzhi Shi (Tsinghua University);Chao Zhang (Georgia Institute of Technology);Quanming Yao (4Paradigm);Yong Li (Tsinghua University);Funing Sun (Tencent);Depeng Jin (Tsinghua University);, State-Sharing Sparse Hidden Markov Models for Personalized Sequences, 2019
+ [19], Prathamesh Deshpande (IIT);Sunita Sarawagi (IIT);, Streaming Adaptation of Deep Forecasting Models using Adaptive Recurrent Units, 2019
+ [19], Lei Guo (Shandong Normal University);Hongzhi Yin (The University of Queensland);Qinyong Wang (The University of Queensland);Tong Chen (The University of Queensland);Alexander Zhou (The University of Queensland);Nguyen Quoc Viet Hung (Griffith University);, Streaming Session-based Recommendation, 2019
+ [19], Zhen Wang (The Ohio State University);Xiang Yue (The Ohio State University);Soheil Moosavinasab (Nationwide Children's Hospital);Yungui Huang (Nationwide Children's Hospital);Simon Lin (Nationwide Children's Hospital);Huan Sun (The Ohio State University);, SurfCon: Synonym Discovery on Privacy-Aware Clinical Data, 2019
+ [19], Shuyang Yu (Northeastern University);Bin Gu (JD.com);Kunpeng Ning (Nanjing University of Aeronautics and Astronautics);Haiyan Chen (Nanjing University of Aeronautics and Astronautics);Jian Pei (Simon Fraser University);Heng Huang (University of Pittsburgh);, Tackle Balancing Constraint for Incremental Semi-Supervised Support Vector Learning, 2019
+ [19], Pei Yang (Arizona State University & South China University of Technology);Qi Tan (South China Normal University);Hanghang Tong (Arizona State University);Jingrui He (Arizona State University);, Task-Adversarial Co-Generative Nets, 2019
+ [19], Romain Warlop (fifty-five);Jérémie Mary (Criteo);Mike Gartrell (Criteo);, Tensorized Determinantal Point Processes for Recommendation, 2019
+ [19], Yuan Deng (Duke University);Sébastien Lahaie (Google);, Testing Dynamic Incentive Compatibility in Display Ad Auctions, 2019
+ [19], Ying Sun (Institute of Computing Technology, Chinese Academy of Sciences);Fuzhen Zhuang (Institute of Computing Technology, Chinese Academy of Sciences);Hengshu Zhu (Baidu);Xin Song (Baidu);Qing He (Institute of Computing Technology, Chinese Academy of Sciences);Hui Xiong (Baidu);, The Impact of Person-Organization Fit on Talent Management: A Structure-Aware Convolutional Neural Network Approach, 2019
+ [19], Tianwen Jiang (University of Notre Dame);Tong Zhao (University of Notre Dame);Bing Qin (Harbin Institute of Technology);Ting Liu (Harbin Institute of Technology);Nitesh Chawla (University of Notre Dame);Meng Jiang (University of Notre Dame);, The Role of “Condition”: A Novel Scientific Knowledge Graph Representation and Construction Model, 2019
+ [19], Boyang Li (Northeastern University);Yurong Cheng (Beijing Institute of Technology);Ye Yuan (Northeastern University);Guoren Wang (Beijing Institute of Technology);Lei Chen (The Hong Kong University of Science and Technology);, Three-Dimensional Stable Matching Problem for Spatial Crowdsourcing Platforms, 2019
+ [19], Stefano Giovanni Rizzo (Qatar Computing Research Institute);Giovanna Vantini (Qatar Computing Research Institute);Sanjay Chawla (Qatar Computing Research Institute);, Time Critic Policy Gradient Methods for Traffic Signal Control in Complex and Congested Scenarios, 2019
+ [19], Xiaowei Jia (University of Minnesota);Sheng Li (University of Georgia);Handong Zhao (Adobe);Sungchul Kim (Adobe);Vipin Kumar (University of Minnesota);, Towards Robust and Discriminative Sequential Data Learning: When and How to Perform Adversarial Training?, 2019
+ [19], Abdulah Fawaz (Siemens);Sebastien Piat (Siemens);Paul Klein (Siemens);Simone Severini (University College London);Peter Mountney (Siemens);, Training and Meta-Training Binary Neural Networks with Quantum Computing, 2019
+ [19], Daheng Wang (University of Notre Dame);Tianwen Jiang (University of Notre Dame);Nitesh Chawla (University of Notre Dame);Meng Jiang (University of Notre Dame);, TUBE: Embedding Behavior Outcomes for Predicting Success, 2019
+ [19], Chengxi Zang (Tsinghua University);Peng Cui (Tsinghua University);Chaoming Song (University of Miami);Wenwu Zhu (Tsinghua University);Fei Wang (Cornell University);, Uncovering Pattern Formation of Information Flow, 2019
+ [19], Yunchao Zhang (Missouri University of Science and Technology);Pengyang Wang (Missouri University of Science and Technology);Xiaolin Li (Nanjing University);Yu Zheng (JD);Yanjie Fu (Missouri University of Science and Technology);, Unifying Inter-region Autocorrelation and Intra-region Structures for Spatial Embedding via Collective Adversarial Learning, 2019
+ [19], Junheng Hao (University of California, Los Angeles);Muhao Chen (University of California, Los Angeles);Wenchao Yu (University of California, Los Angeles);Yizhou Sun (University of California, Los Angeles);Wei Wang (University of California, Los Angeles);, Universal Representation Learning of Knowledge Bases by Jointly Embedding Instances and Ontological Concepts, 2019
+ [19], Zheyi Pan (Shanghai Jiao Tong University);Yuxuan Liang (National University of Singapore);Weifeng Wang (Shanghai Jiao Tong University);Yong Yu (Shanghai Jiao Tong University);Yu Zheng (JD);Junbo Zhang (JD);, Urban Traffic Prediction from Spatio-Temporal Data using Deep Meta Learning, 2019
+ [19], Yihong Chen (Tsinghua University);Bei Chen (Microsoft);Xiangnan He (University of Science and Technology of China);Chen Gao (Tsinghua University);Yong Li (Tsinghua University);Jian-Guang Lou (Microsoft);Yue Wang (Tsinghua University);, λOpt: Learn to Regularize Recommender Models in Finer Levels, 2019


#### Applied Data Science Track Papers
+ [19], Pablo Estevez, Themistoklis Mavridis and Lucas Bernardi, 150 successful Machine Learning models: 6 lessons learned at Booking.com, 2019
+ [19], Jingbo Zhou, Shan Gou, Renjun Hu, Dongxiang Zhang, Jin Xu, Xuehui Wu, Airong Jiang and Hui Xiong, A Collaborative Learning Framework to Tag Refinement for Points of Interest, 2019
+ [19], Lei Chen, Xialiang Tong, Mingxuan Yuan, Jia Zeng and Lei Chen, A Data-Driven Approach for Multi-level Packing Problems in Manufacturing Industry, 2019
+ [19], Fred.X Han, Di Niu, Haolan Chen, Kunfeng Lai, Yancheng He and Yu Xu, A Deep Generative Approach to Search Extrapolation and Recommendation, 2019
+ [19], Xiaocheng Tang, Zhiwei Qin, Fan Zhang, Zhaodong Wang, Zhe Xu, Yintai Ma, Hongtu Zhu and Jieping Ye, A Deep Value-network Based Approach for Multi-Driver Order Dispatching, 2019
+ [19], Ang Li, Ola Spyra, Sagi Perel, Valentin Dalibard, Max Jaderberg, Chenjie Gu, David Budden, Tim Harley and Pramod Gupta, A Generalized Framework for Population Based Training, 2019
+ [19], Prithwish Chakraborty and Faisal Farooq, A Robust Framework for Accelerated Outcome-driven Risk Factor Identification from EHR, 2019
+ [19], Peng Tian, Yuan Guo, Jayashree Kalpathy-Cramer, Susan Ostmo, J. Peter Campbell, Michael F. Chiang, Jennifer Dy, Deniz Erdogmus and Stratis Ioannidis, A Severity Score for Retinopathy of Prematurity, 2019
+ [19], Kui Zhao, Junhao Hua, Ling Yan, Qi Zhang, Huan Xu and Cheng Yang, A Unified Framework for Marketing Budget Allocation, 2019
+ [19], Bang Liu, Weidong Guo, Di Niu, Chaoyue Wang, Shunnan Xu, Jinghong Lin, Kunfeng Lai and Yu Xu, A User-Centered Concept Mining System for Query and Document Understanding at Tencent, 2019
+ [19], Zhipeng Luo, Jianqiang Huang, Ke Hu, Xue Li and Peng Zhang, AccuAir: Winning Solution to Air Quality Prediction for KDD Cup 2018, 2019
+ [19], Tom Decroos, Lotte Bransen, Jan Van Haaren and Jesse Davis, Actions Speak Louder Than Goals: Valuing Player Actions in Soccer, 2019
+ [19], H M Sajjad Hossain and Nirmalya Roy, Active Deep Learning for Activity Recognition with Context Aware Annotator Selection, 2019
+ [19], Xiao Hui Tai, Kyle Soska and Nicolas Christin, Adversarial Matching of Dark Net Market Vendor Accounts, 2019
+ [19], Xiao Yang, AiAds: Automated and Intelligent Advertising System for Sponsored Search, 2019
+ [19], Xiaoli Tang, Tengyun Wang, Haizhi Yang and Hengjie Song, AKUPM: Attention-Enhanced Knowledge-Aware User Preference Model for Recommendation, 2019
+ [19], Jingyuan Wang, Yang Zhang, Ke Tang, Junjie Wu and Zhang Xiong, AlphaStock: Buying Winners and Selling Losers in Deep, 2019
+ [19], Maxime Voisin, Yichen Shen, Alireza Aliamiri, Anand Avati, Awni Hannun and Andrew Ng, Ambulatory Atrial Fibrillation Monitoring Using Wearable Photoplethysmography with Deep Learning, 2019
+ [19], Jagdish Ramakrishnan, Elham Shaabani, Chao Li and Mátyás Sustik, Anomaly Detection for an E-commerce Pricing System, 2019
+ [19], Malay Haldar, Mustafa Abdool, Prashant Ramanathan, Tao Xu, Shulin Yang, Huizhong Duan, Qing Zhang, Nick Barrow-Williams, Bradley C. Turnbull, Brendan M. Collins and Thomas Legrand, Applying Deep Learning To Airbnb Search, 2019
+ [19], Haifeng Jin, Qingquan Song and Xia Hu, Auto-Keras: An Efficient Neural Architecture Search System, 2019
+ [19], Luo Yuanfei, Mengshuo Wang, Hao Zhou, Quanming Yao, Wei-Wei Tu, Yuqiang Chen, Qiang Yang and Wenyuan Dai, AutoCross: Automatic Feature Crossing for Tabular Data in Real-World Applications, 2019
+ [19], Chunyi Liu, Peng Wang, Jiang Xu, Zang Li and Jieping Ye, Automatic Dialogue Summary Generation for Customer Service, 2019
+ [19], Xun Yang, Yasong Li, Hao Wang, Di Wu, Qing Tan, Jian Xu and Kun Gai, Bid Optimization by Multivariable Control in Display Advertising, 2019
+ [19], Lisa Singh, Laila Wahedi, Yanchen Wang, Yifang Wei, Christo Kirov, Susan Martin, Katharine Donato, Yaguang Liu and Kornraphop Kawintiranon, Blending Noisy Social Media Signals with Traditional Movement Variables to Predict Forced Migration, 2019
+ [19], Long Guo, Lifeng Hua, Rongfei Jia, Binqiang Zhao, Xiaobo Wang and Bin Cui, Buying or Browsing? : Predicting Real-time Purchasing Intent using Attention-based Deep Network with Multiple Behavior, 2019
+ [19], Oren Somekh, Michal Aharon, Avi Shahar, Assaf Singer, Boris Trayvas, Hadas Vogel and Dobri Dobrev, Carousel Ads Optimization in Yahoo Gemini Native, 2019
+ [19], Seiya Tokui, Ryosuke Okuta, Takuya Akiba, Yusuke Niitani, Toru Ogawa, Shunta Saito, Shuji Suzuki, Kota Uenishi, Brian Vogel and Hiroyuki Yamazaki Vincent, Chainer: a Deep Learning Framework for Accelerating the Research Cycle, 2019
+ [19], Zenghua Xia, Chang Liu, Neil Gong, Qi Li, Yong Cui and Dawn Song, Characterizing and Detecting Malicious Accounts inPrivacy-Centric Mobile Social Networks: A Case Study, 2019
+ [19], Yozen Liu, Xiaolin Shi, Lucas Pierce and Xiang Ren, Characterizing and Forecasting User Engagement with In-App Action Graphs: A Case Study of Snapchat, 2019
+ [19], Pan Li, Zhen Qin, Xuanhui Wang and Donald Metzler, Combining Decision Trees and Neural Networks forLearning-to-Rank in Personal Search, 2019
+ [19], Zhe Chen, Aixin Sun and Xiaokui Xiao, Community Detection on Large Complex Attribute Network, 2019
+ [19], Ari Kobren, Pablo Bario, Oksana Yakhnenko, Johann Hibschman and Ian Langmore, Constructing High Precision Knowledge Bases with Subjective and Factual Attributes, 2019
+ [19], Jan-Philipp Schulze, Artur Mrowca, Elizabeth Ren, Hans-Andrea Loeliger and Konstantin Böttinger, Context by Proxy: Identifying Contextual Anomalies Using an Output Proxy, 2019
+ [19], Shunsuke Kitada, Hitoshi Iyatomi and Yoshifumi Seki, Conversion Prediction Using Multi-task Conditional Attention Networks to Support the Creation of Effective Ad Creatives, 2019
+ [19], Vihan Lakshman, Vijai Mohan, Priyanka Nigam, Yiwei Song, Weitian Ding, Ankit Shingavi, Choon Hui Teo, Hao Gu and Bing Yin, Deep Semantic Product Search, 2019
+ [19], Wentao Ouyang, Xiuwu Zhang, Li Li, Heng Zou, Xin Xing, Zhaojie Liu and Yanlong Du, Deep Spatio-Temporal Neural Networks for Click-Through Rate Prediction, 2019
+ [19], Bin Wang, Jie Lu, Zheng Yan, Huaishao Luo, Tianrui Li, Yu Zheng and Guangquan Zhang, Deep Uncertainty Quantification: A Machine Learning Approach for Weather Forecasting, 2019
+ [19], Anthony Sicilia, Konstantinos Pelechrinis and Kirk Goldsberry, DeepHoops: Evaluating Micro-Actions in Basketball Using Deep Feature Representations of Spatio-Temporal Data, 2019
+ [19], Stephen Lee, Srinivasan Iyengar, Menghong Feng, Prashant Shenoy and Subhransu Maji, DeepRoof: A Data-driven Approach For Solar Potential Estimation Using Rooftop Imagery, 2019
+ [19], Renhe Jiang, Xuan Song, Dou Huang, Xiaoya Song, Tianqi Xia, Zekun Cai, Zhaonan Wang, Kyoung-Sook Kim and Ryosuke Shibasaki, DeepUrbanEvent: A System for Predicting Citywide Crowd Dynamics at Big Events, 2019
+ [19], Simon Woo, Shahroz Tariq, Sangyup Lee, Youjin Shin, Myeong Shin Lee, Okchul Jung and Daewon Chung, Detecting Anomalies in Space using Multivariate Convolutional LSTM with Mixtures of Probabilistic PCA, 2019
+ [19], Anil Yelundur, Vineet Chaoji and Bamdev Mishra, Detection of Review Abuse via Semi-Supervised Binary Multi-Target Tensor Decomposition, 2019
+ [19], Richard Chen, Filip Jankovic, Nikki Marinsek, Luca Foschini, Lampros Kourtis, Alessio Signorini, Melissa Pugh, Jie Shen, Roy Yaari, Vera Maljkovic, Marc Sunga, Han Hee Song, Hyun Joon Jung, Belle Tseng and Andrew Trister, Developing Measures of Cognitive Impairment in the Real World from Consumer-Grade Multimodal Sensor Streams, 2019
+ [19], Aleksander Fabijan, Jayant Gupchup, Somit Gupta, Jeff Omhover, Wen Quin, Lukas Vermeer and Pavel Dmitriev, Diagnosing Sample Ratio Mismatch in Online Controlled Experiments: A Taxonomy and Rules of Thumb for Practitioners, 2019
+ [19], Chuan Qin, Hengshu Zhu, Chen Zhu, Tong Xu, Fuzhen Zhuang, Chao Ma, Jingshuai Zhang and Hui Xiong, DuerQuiz: A Personalized Question Recommender System for Intelligent Job Interview, 2019
+ [19], Naman Shukla, Arinbjörn Kolbeinsson, Ken Otwell, Lavanya Marla and Kartik Yellepeddi, Dynamic Pricing for Airline Ancillaries with Customer Context, 2019
+ [19], Alexander Tuzhilin, Dmitri Babaev, Dmitri Umerenkov and Maxim Savchenko, E.T.-RNN: Applying Deep Learning to Credit Loan Applications, 2019
+ [19], Kiri Wagstaff, Gary Doran, Ashley Davies, Saadat Anwar, Srija Chakraborty, Marissa Cameron, Ingrid Daubar and Cynthia Phillips, Enabling Onboard Detection of Events of Scientific Interest for the Europa Clipper Spacecraft, 2019
+ [19], Laurence Yang, Michael A. Saunders, Jean-Christophe Lachance, Bernhard O. Palsson and José Bento, Estimating Cellular Goals from High-Dimensional Biological Data, 2019
+ [19], Alex Beutel, Jilin Chen, Tulsee Doshi, Hai Qian, Li Wei, Yi Wu, Lukasz Heldt, Zhe Zhao, Lichan Hong, Ed H. Chi and Cristos Goodrow, Fairness in Recommendation Ranking through Pairwise Comparisons, 2019
+ [19], Sahin Geyik, Stuart Ambler and Krishnaram Kenthapadi, Fairness-Aware Ranking in Search & Recommendation Systems with Application to LinkedIn Talent Search, 2019
+ [19], Yaochen Hu, Di Niu, Jianming Yang and Shengping Zhou, FDML: A Collaborative Machine Learning Framework for Distributed Features, 2019
+ [19], Ye Tu, Chun Lo, Yiping Yuan and Shaunak Chatterjee, Feedback Shaping: A Modeling Approach to Nurture Content Creation, 2019
+ [19], Stephanie Dewet and Jiafan Ou, Finding Users Who Act Alike: Transfer Learning for Expanding Advertiser Audiences, 2019
+ [19], Doyen Sahoo, Hao Wang, Shu Ke, Xiongwei Wu, Hung Le, Palakorn Achananuparp, Ee-Peng Lim and Steven Hoi, FoodAI: Food Image Recognition via Deep Learning for Smart Food Logging, 2019
+ [19], John Hughes, Keng-Hao Chang and Ruofei Zhang, Generating Better Search Engine Text Advertisements with Deep Reinforcement Learning, 2019
+ [19], Yuhui Zheng, Linchuan Xu, Taichi Kiwaki, Jing Wang, Hiroshi Murata, Ryo Asaoka and Kenji Yamanishi, Glaucoma Progression Prediction Using Retinal Thickness via Latent Space Linear Regression, 2019
+ [19], Mia Xu Chen, Benjamin N Lee, Gagan Bansal, Yuan Cao, Shuyuan Zhang, Justin Lu, Jackie Tsay, Yinan Wang, Andrew M. Dai, Zhifeng Chen, Timothy Sohn and Yonghui Wu, Gmail Smart Compose: Real-Time Assisted Writing, 2019
+ [19], Andrew Tomkins, Ravi Kumar, Neha Arora, James Cook, Ivan Kuznetsov, Yechen Li, Huai-Jen Liang, Andrew Miller, Iveel Tsogsuren and Yi Wang, Hard to Park? Estimating Parking Difficulty at Scale, 2019
+ [19], Shanshan Zhang, Lihong He, Eduard Dragut and Slobodan Vucetic, How to Invest my Time: Lessons from HITL Entity Extraction, 2019
+ [19], Hao Liu, Yongxin Tong, Panpan Zhang, Xinjiang Lu, Jianguo Duan and Hui Xiong, Hydra: A Personalized and Context-Aware Multi-Modal Transportation Recommendation System, 2019
+ [19], Jessica Hwang, Paulo Orenstein, Judah Cohen, Karl Pfeiffer and Lester Mackey, Improving Subseasonal Forecasting in the Western U.S. with Machine Learning, 2019
+ [19], Xichen Ding, Jie Tang, Tracy Liu, Cheng Xu, Yaping Zhang, Feng Shi, Qixia Jiang and Dan Shen, Infer Implicit Contexts in Real-time Online-to-Offline Recommendation, 2019
+ [19], Jun Zhao, Zhou Zhou, Ziyu Guan, Wei Zhao, Ning Wei, Guang Qiu and Xiaofei He, IntentGC: a Scalable Graph Convolution Framework Fusing Heterogeneous Information for Recommendation, 2019
+ [19], Rupesh Gupta, Guangde Chen and Shipeng Yu, Internal Promotion Optimization, 2019
+ [19], John Lu, Sumati Sridhar, Ritika Pandey, Mohammad Hasan and George Mohler, Investigate Transitions into Drug Addiction through Text Mining of Reddit Data, 2019
+ [19], Chi Chen, Li Zhao, Jiang Bian, Chunxiao Xing and Tie-Yan Liu, Investment Behaviors Can Tell What Inside: Exploring Stock Intrinsic Properties for Stock Trend Prediction, 2019
+ [19], Dipendra Jha, Logan Ward, Zijiang Yang, Christopher Wolverton, Ian Foster, Wei-Keng Liao, Alok Choudhary and Ankit Agrawal, IRNet: A General Purpose Deep Residual Regression Framework For Materials Discovery, 2019
+ [19], Seong Jae Hwang, Joonseok Lee, Balakrishnan Varadarajan, Ariel Gordon, Zheng Xu and Apostol Natsev, Large-Scale Training Framework for Video Annotation, 2019
+ [19], Xiaoyang Ma, Lan Zhang, Lan Xu, Zhicheng Liu, Ge Chen, Zhili Xiao, Yang Wang and Zhengtao Wu, Large-scale User Visits Understanding and Forecasting with Deep Spatial-Temporal Tensor Factorization Framework, 2019
+ [19], Andrew Zhai, Hao-Yu Wu, Eric Tzeng, Dong Huk Park and Charles Rosenberg, Learning a Unified Embedding for Visual Search at Pinterest, 2019
+ [19], Sungkyu Park, Cheng-Te Li, Sungwon Han, Cheng Hsu, Sang Won Lee and Meeyoung Cha, Learning Sleep Quality from Daily Logs, 2019
+ [19], Jackson Killian, Bryan Wilder, Amit Sharma, Vinod Choudhary, Bistra Dilkina and Milind Tambe, Learning to Prescribe Interventions for Tuberculosis Patients using Digital Adherence Data, 2019
+ [19], Yangli-Ao Geng, Qingyong Li, Tianyang Lin, Lei Jiang, Liangtao Xu, Dong Zheng, Wen Yao, Yijun Zhang and Weitao Lyu, LightNet: A Dual Spatiotemporal Encoder Network Model for Lightning Prediction, 2019
+ [19], Zeeshan Ahmed, Saeed Amizadeh, Mikhail Bilenko, Rogan Carr, Wei-Sheng Chin, Yael Dekel, Xavier Dupre, Vadim Eksarevskiy, Senja Filipi, Tom Finley, Abhishek Goswami, Monte Hoover, Scott Inglis, Matteo Interlandi, Najeeb Kazmi, Gleb Krivosheev, Pete Luferenko, Ivan Matantsev, Sergiy Matusevych, Shahab Moradi, Gani Nazirov, Justin Ormont, Gal Oshri, Artidoro Pagnoni, Jignesh Parmar, Prabhat Roy, Zeeshan Siddiqui, Markus Weimer, Shauheen Zahirazami and Yiwen Zhu, Machine Learning at Microsoft with ML.NET, 2019
+ [19], Megha Srivastava, Hoda Heidari and Andreas Krause, Mathematical Notions vs. Human Perception of Fairness: A Descriptive Approach to Fairness for Machine Learning, 2019
+ [19], Junting Ye and Steven Skiena, MediaRank: Compuational Ranking of Online News Sources, 2019
+ [19], Shaohua Fan, Junxiong Zhu, Xiaotian Han, Chuan Shi, Linmei Hu, Biyu Ma and Yongliang Li, Metapath-guided Heterogeneous Graph Neural Network for Intent Recommendation, 2019
+ [19], Xi Zhang, Andy Tang, Hiroko Dodge, Jiayu Zhou and Fei Wang, MetaPred: Meta-Learning for Clinical Risk Prediction with Limited Patient Electronic Health Records, 2019
+ [19], Miao Fan, Jiacheng Guo, Shuai Zhu, Shuo Miao, Mingming Sun and Ping Li, MOBIUS: Towards the Next Generation of Query-Ad Matching in Baidu's Sponsored Search, 2019
+ [19], Yina Tang, Fedor Borisyuk, Siddarth Malreddy, Yixuan Li, Yiqun Liu and Sergey Kirshner, MSURU: Large Scale E-commerce Image Classification With Weakly Supervised Search Data, 2019
+ [19], Chenyou Fan, Yuze Zhang, Yi Pan, Xiaoyue Li, Chi Zhang, Rong Yuan, Di Wu, Wensheng Wang, Jian Pei and Heng Huang, Multi-Horizon Time Series Forecasting with Temporal Attention Learning, 2019
+ [19], Jianrong Tao, Jianshi Lin, Shize Zhang, Sha Zhao, Runze Wu, Changjie Fan and Peng Cui, MVAN: Multi-view Attention Networks for Real Money Trading Detection in Online Games, 2019
+ [19], Bhanu Pratap Singh Rawat, Fei Li and Hong Yu, Naranjo Question Answering using End-to-End Multi-task Learning Model, 2019
+ [19], Yumin Liu, Junxiang Chen, Auroop Ganguly and Jennifer Dy, Nonparametric Mixture of Sparse Regressions on Spatio-Temporal Data -- An Application to Climate Prediction, 2019
+ [19], Amol Kapoor, Hunter Larco and Raimondas Kiveris, Nostalgin: Extracting 3D City Models from Historical Image Data, 2019
+ [19], Chuhan Wu, Fangzhao Wu, Mingxiao An, Jianqiang Huang, Yongfeng Huang and Xing Xie, NPA: Neural News Recommendation with Personalized Attention, 2019
+ [19], Fanjin Zhang, Xiao Liu, Jie Tang, Yuxiao Dong, Peiran Yao, Jie Zhang, Xiaotao Gu, Yan Wang, Bin Shao, Rui Li and Kuansan Wang, OAG: Toward Linking Large-scale Heterogeneous Entity Graphs, 2019
+ [19], Yue Weng, Huaixiu Zheng, Franziska Bell and Gokhan Tur, OCC: A Smart Reply System for Efficient In-App Communications, 2019
+ [19], Chin-Chia Michael Yeh, Yan Zhu, Hoang Anh Dau, Amirali Darvishzadeh, Mikhail Noskov and Eamonn Keogh, Online Amnestic DTW to allow Real-Time Golden Batch Monitoring, 2019
+ [19], Chao Huang, Xian Wu, Xuchao Zhang, Chuxu Zhang, Jiashu Zhao, Dawei Yin and Nitesh Chawla, Online Purchase Prediction via Multi-Scale Modeling of Behavior Dynamics, 2019
+ [19], Takuya Akiba, Shotaro Sano, Toshihiko Yanase, Takeru Ohta and Masanori Koyama, Optuna: A Next-generation Hyperparameter Optimization Framework, 2019
+ [19], Wei Zhao, Boxuan Zhang, Beidou Wang, Ziyu Guan, Wanxian Guan, Guang Qiu, Wei Ning, Jiming Chen and Hongmin Liu, Personalized Attraction Enhanced Sponsored Search with Multi-task Learning, 2019
+ [19], Mathias Kraus and Stefan Feuerriegel, Personalized Purchase Prediction of Market Baskets with Wasserstein-Based Sequence Matching, 2019
+ [19], Jinfeng Zhuang and Yu Liu, PinText: A Multitask Text Embedding System in Pinterest, 2019
+ [19], Wen Chen, Pipei Huang, Jiaming Xu, Xin Guo, Cheng Guo, Fei Sun, Chao Li, Andreas Pfadler, Huan Zhao and Binqiang Zhao, POG: Personalized Outfit Generation for Fashion Recommendation at Alibaba iFashion, 2019
+ [19], Qi Pi, Weijie Bian, Guorui Zhou, Xiaoqiang Zhu and Kun Gai, Practice on Long Sequential User Behavior Modeling for Click-Through Rate Prediction, 2019
+ [19], Vadim Lebedev, Vladimir Ivashkin, Irina Rudenko, Alexander Ganshin, Ivan Bushmarinov, Alexander Molchanov, Sergey Ovcharenko, Ruslan Grokhovetskiy and Dmitry Solomentsev, Precipitation nowcasting with satellite imagery, 2019
+ [19], Junwei Pan, Yizhi Mao, Alfonso Lobos Ruiz, Yu Sun and Aaron Flores, Predicting Different Types of Conversions with Multi-Task Learning in Online Advertising, 2019
+ [19], Evan Sheehan, Chenlin Meng, Matthew Tan, Burak Uzkent, Neal Jean, David Lobell, Marshall Burke and Stefano Ermon, Predicting Economic Development using Geolocated Wikipedia Articles, 2019
+ [19], Takahiro Yabe, Kota Tsubouchi, Toru Shimizu, Yoshihide Sekimoto and Satish Ukkusuri, Predicting Evacuation Decisions using Representations of Individuals' Pre-Disaster Web Search Behavior, 2019
+ [19], Ehimwenma Nosakhare and Rosalind Picard, Probabilistic Latent Variable Modeling for Assessing Behavioral Influences on Well-Being, 2019
+ [19], Alexey Svyatkovskiy, Ying Zhao, Shengyu Fu and Neel Sundaresan, Pythia: AI assisted code completion system, 2019
+ [19], Shiwen Zhao, Brandt Westing, Shawn Scully, Heri Nieto, Roman Holenstein, Minwoo Jeong, Krishna Sridhar, Brandon Newendorp, Mike Bastian, Sethu Raman, Tim Paek, Kevin Lynch and Carlos Guestrin, Raise to speak: an accurate, low-power detector for activating voice assistants on smartwatches, 2019
+ [19], David Rolnick, Kevin Aydin, Jean Pouget-Abadie, Shahab Kamali, Vahab Mirrokni and Amir Najmi, Randomized Experimental Design via Geographic Clustering, 2019
+ [19], Peng Jiang, Yingrui Yang, Gann Bierner, Fengjie Alex Li, Ruhan Wang and Azadeh Moghtaderi, Ranking in Genealogy: Search Results Fusion at Ancestry, 2019
+ [19], Yudan Liu, Kaikai Ge, Xu Zhang and Leyu Lin, Real-time Attention Based Look-alike Model for Recommender System, 2019
+ [19], Mateusz Fedoryszak, Brent Frederick, Vijay Rajaram and Changtao Zhong, Real-time Event Detection on Social Data Streams, 2019
+ [19], Keiichi Ochiai, Kohei Senkawa, Naoki Yamamoto, Yuya Tanaka and Yusuke Fukazawa, Real-time On-Device Troubleshooting Recommendation for Smartphones, 2019
+ [19], Tadashi Okoshi, Kota Tsubouchi and Hideyuki Tokuda, Real-World Product Deployment of Adaptive Push Notification Scheduling on Smartphones, 2019
+ [19], Nicolas Grislain, Nicolas Perrin and Antoine Thabault, Recurrent Neural Networks for Stochastic Control in Real-Time Bidding, 2019
+ [19], Lixin Zou, Long Xia, Zhuoye Ding, Song Jiaxing, Weidong Liu and Dawei Yin, Reinforcement Learning to Optimize Long-term User Engagement in Recommender Systems, 2019
+ [19], Achir Kalra, Chong Wang, Cristian Borcea and Yi Chen, Reserve Price Failure Rate Prediction with Header Bidding in Display Advertising, 2019
+ [19], Ya Su, Youjian Zhao, Chenhao Niu, Rong Liu, Wei Sun and Dan Pei, Robust Anomaly Detection for Multivariate Time Series through Stochastic Recurrent Neural Network, 2019
+ [19], Ming Lin, Xiaomin Song, Qi Qian, Hao Li, Liang Sun, Shenghuo Zhu and Rong Jin, Robust Gaussian Process Regression for Real-Time High Precision GPS Signal Enhancement, 2019
+ [19], Zhibin Li, Jian Zhang, Qiang Wu, Yongshun Gong, Jinfeng Yi and Christina Kirsch, Sample Adaptive Multiple Kernel Learning for Failure Prediction of Railway Points, 2019
+ [19], Quang Thien Tran and Jun Sakuma, Seasonal-adjustment based feature selection method for predicting epidemic with large-scale search engine logs, 2019
+ [19], Ari Biswas, Thai Pham, Michael Vogelsong, Benjamin Snyder and Houssam Nassif, Seeker: Real-Time Interactive Search, 2019
+ [19], Dimitris Spathis, Sandra Servia Rodríguez, Katayoun Farrahi, Cecilia Mascolo and Jason Rentfrow, Sequence Multi-task Learning to Forecast Mental Wellbeing from Sparse Self-reported Data, 2019
+ [19], Zhengxiao Du, Xiaowei Wang, Hongxia Yang, Jingren Zhou and Jie Tang, Sequential Scenario-Specific Meta Learner for Online Recommendation, 2019
+ [19], Sobhan Moosavi, Mohammad Hossein Samavatian, Arnab Nandi, Srinivasan Parthasarathy and Rajiv Ramnath, Short and Long-term Pattern Discovery Over Large-Scale Geo-Spatiotemporal Data, 2019
+ [19], Drew Dimmery, Eytan Bakshy and Jasjeet Sekhon, Shrinkage Estimators in Online Experiments, 2019
+ [19], Di Jin, Mark Heimann, Tara Safavi, Mengdi Wang, Wei Lee, Lindsay Snider and Danai Koutra, Smart Roles: Inferring Professional Roles in Email Networks, 2019
+ [19], Abhilash Reddy Chenreddy, Parshan Pakiman, Selvaprabu Nadarajah, Ranganathan Chandrasekaran and Rick Abens, SMOILE: A Shopper Marketing Optimization and Inverse Learning Engine, 2019
+ [19], Xiao Yan, Jaewon Yang, Mikhail Obukhov, Lin Zhu, Joey Bai, Shiqi Wu and Qi He, Social Skill Validation at LinkedIn, 2019
+ [19], Farhan Asif Chowdhury, Satomi Suzuki and Abdullah Mueen, Structured Noise Detection: Application on Well Test Pressure Derivative Data, 2019
+ [19], Eitam Sheetrit, Nir Nissim, Denis Klimov and Yuval Shahar, Temporal Probabilistic Profiles for Sepsis Prediction in the ICU, 2019
+ [19], Rama Kumar Pasumarthi, Sebastian Bruch, Xuanhui Wang, Cheng Li, Michael Bendersky, Marc Najork, Jan Pfeifer, Nadav Golbandi, Rohan Anil and Stephan Wolf, TF-Ranking: Scalable TensorFlow Library for Learning-to-Rank, 2019
+ [19], Christian Schön, Jens Dittrich and Richard Müller, The Error is the Feature: How to Forecast Lightning using a Model Prediction Error, 2019
+ [19], Xuan Yin and Liangjie Hong, The Identification and Estimation of Direct and Indirect Effects in Online A/B Tests through Causal Mediation Analysis, 2019
+ [19], Junting Ye and Steven Skiena, The Secret Lives of Names? Name Embeddings from Social Media, 2019
+ [19], Hansheng Ren, Bixiong Xu, Yujing Wang, Chao Yi, Congrui Huang, Tony Xing, Xiaoyu Kou, Mao Yang and Jie Tong, Time-Series Anomaly Detection Service at Microsoft, 2019
+ [19], Xiao Zhou, Cecilia Mascolo and Zhongxiang Zhao, Topic-Enhanced Memory Networks for Personalised Point-of-Interest Recommendation, 2019
+ [19], Shobha Venkataraman and Jia Wang, Towards Identifying Impacted Users in Cellular Services, 2019
+ [19], Qibin Chen, Junyang Lin, Yichang Zhang, Hongxia Yang, Jingren Zhou and Jie Tang, Towards Knowledge-Based Personalized Product Description Generation in E-commerce, 2019
+ [19], Kevin Fauvel, Véronique Masson, Élisa Fromont, Philippe Faverdin and Alexandre Termier, Towards sustainable dairy management - a machine learning enhanced method for estrus detection, 2019
+ [19], Zheyi Pan, Jie Bao, Weinan Zhang, Yong Yu and Yu Zheng, TrajGuard: A Comprehensive Trajectory Copyright Protection Scheme, 2019
+ [19], Yasuhisa Suzuki, Wemer Wee and Itaru Nishioka, TV Advertisement Scheduling by Learning Expert Intentions, 2019
+ [19], Tom Sühr, Asia J. Biega, Meike Zehlike, Krishna P. Gummadi and Abhijnan Chakraborty, Two-Sided Fairness for Repeated Matchings in Two-Sided Markets: A Case Study of a Ride-Hailing Platform, 2019
+ [19], Yunfei Lu, Linyun Yu, Peng Cui, Chengxi Zang, Renzhe Xu, Yihao Liu, Lei Li and Wenwu Zhu, Uncovering the Co-driven Mechanism of Social and Content Links in User Churn Phenomena, 2019
+ [19], Yichao Zhou, Shaunak Mishra, Jelena Gligorijevic, Tarun Bhatia and Narayan Bhamidipati, Understanding Consumer Journey using Attention based Recurrent Neural Networks, 2019
+ [19], Hao Jiang, Aakash Sabharwal, Adam Henderson, Diane Hu and Liangjie Hong, Understanding the Role of Style in E-commerce Shopping, 2019
+ [19], Wei-Hung Weng, Yu-An Chung and Peter Szolovits, Unsupervised Clinical Language Translation, 2019
+ [19], Yuxuan Liang, Kun Ouyang, Lin Jing, Sijie Ruan, Ye Liu, Junbo Zhang, David Rosenblum and Yu Zheng, UrbanFM: Inferring Fine-Grained Urban Flows, 2019
+ [19], Haipeng Chen, Rui Liu, Noseong Park and V.S. Subrahmanian, Using Twitter to Predict When Vulnerabilities will be Exploited, 2019
+ [19], Weicong Ding, Dinesh Govindaraj and S V N Vishwanathan, Whole Page Optimization with Global Constraints, 2019
